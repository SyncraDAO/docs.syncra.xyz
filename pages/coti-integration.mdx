...
- Tests ensured that individual votes and token amounts remained private, with only aggregated results (e.g., proposal outcomes) visible when the voting ends.
...
graph TD
    ...
    B --> C[Deploy DAOs<br>COTI Mainnet]
    C --> D[Private Voting<br>Encrypted Governance]
```

## Key Takeaways for Users

- **Privacy**: Vote and propose without exposing your tokens, or actions.
